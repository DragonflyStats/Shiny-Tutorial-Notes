---
title: "``shinyWidgets::useShinydashboard``"
...
Allow to use functions from ’shinydashboard’ into a classic ’shiny’ app, specifically valueBox,
infoBox and box.useShinydashboard
